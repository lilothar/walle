#ifndef WALLE_STL_INTERNAL_TYPE_COMPOUND_H_
#define WALLE_STL_INTERNAL_TYPE_COMPOUND_H_
...
namespace std
{
    ...
    // evaluated as a union via WALLESTL_DECLARE_UNION.
    ///////////////////////////////////////////////////////////////////////
    template <typename T> struct is_union : public false_type{};

    #define WALLESTL_DECLARE_UNION(T) namespace wallestl{ template <> struct is_union<T> : public true_type{}; template <> struct is_union<const T> : public true_type{}; }
    ...
    #define WALLESTL_DECLARE_ENUM(T) namespace wallestl{ template <> struct is_enum<T> : public true_type{}; template <> struct is_enum<const T> : public true_type{}; }
